...
const Dynamo = Document => class extends Document {
  ...
  static get defaultIndex() {
    return { primaryKey: 'resourceName', sortKey: 'createdAt' }
  }
  ...
  static _read(query, options) {
    return readItem(client, this.resourceName, this.tableName, query, options, this.indexes)
  }

  static _delete(query) {
    return deleteItem(client, this.resourceName, this.tableName, query)
  }
  ...
  static _update(query, attributes) {
    ...
    return updateItem(client, this.resourceName, this.tableName, query, attributes)
  }
