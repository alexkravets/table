...
const getKeyConditionAndFilterParameters = (primaryKey, primaryKeyValue, query) => {
  const {
    ExpressionAttributeNames,
    ExpressionAttributeValues,
...
const indexItems = async(client, resourceName, TableName, query = {}, options = {}, indexes) => {
  ...
  let parameters = getKeyConditionAndFilterParameters(primaryKey, primaryKeyValue, query)
